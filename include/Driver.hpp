...
namespace sb{
    ...
    /**
     * @brief  Interface entre o PreScanner e o PreParser
     * Essa classe visa interfacear as classes PreScanner e PreParser bem como salvar
    ...
    public:
        ...
        /**
         * @brief Método que realiza o pré-processamento de um código
         *
         * @param srcStream é um std::istream contendo o stream carregado\
         *        com o código que vai ser pré-processado
         * @param dst é um std::string contendo o nome do arquivo ao qual\
         *        o binário pré-processado será salvo
         */
         ...
         *        que foi pré-processado e vai ter as macros expandidas
         * @param dst é um std::string contendo o nome do arquivo ao qual\
    ...
    private:
        ...
        /**
         * @brief Método que salva um EQU baseada na sua label
         *
         * @param label é a label que identifica a EQU
         * @param value é a string com as linhas da EQU
         */
        void insertEqu(std::string label, int value);
        
        /**
         * @brief Método que pega a EQU da memória
         *
         * @param label label que identifica a EQU
         */
        ...
        std::map<std::string, int> equMap; /**< map com as EQU */
        std::map<int, std::string> preMap; /**< map com o pre-processamento */
    };
}
