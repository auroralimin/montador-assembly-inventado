#ifndef MONT_DRIVER_HPP
#define MONT_DRIVER_HPP
...
namespace mont{
    ...
    class Driver{
        public:
            ...
            /**
             * @brief Injeção de amizade com a classe mont::Parser
             * @relates mont::Parser
             */
            friend Parser;
        ...
        private:
             ...
             *
             * @param error é um ponteiro para mont::Error que contém a instância\
            ...
            /**
             * @brief Seta a seção atual como de algum tipo definido por mont::sec
             *
             * @param s é um mont::sec contendo o tipo de seção
             */
            void setSection(mont::sec s);
